        ...
        <Navbar className={`navbar navbar-expand-lg navbar-light ${isSticky ? "navStyle" : "navDefault"}`} expand="lg">
            <Container>
                <Navbar.Brand as={Link} to="/" onClick={scrollTop} className="navBrn">
                    {/*<FontAwesomeIcon icon={faBuffer} className="brnIcon" /> Affliate <span className="navHighlight">Demo</span>*/}
                    <FontAwesomeIcon className="brnIcon" /> Affliate <span className="navHighlight">Demo</span>
                </Navbar.Brand>
